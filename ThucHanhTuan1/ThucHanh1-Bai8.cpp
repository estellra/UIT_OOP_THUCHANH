...
bool ktmachuyenbay(const string& a) {
...
bool ktngay(int ng, int t, int n) {
...
bool ktthoigian(int h,int m) {
    return (h>=0&&h<24&&m>= 0&&m<60);
}

bool ktdiadiem(const string&a) {
...
private:
    ...
    public:
        ...
        bool operator<(const ChuyenBay& cb) const {
    ...
    void timkiemtheongaydivanoidi(string,int,int,int);
    void timkiemtheonoidivanoiden(string,string);
    void sapXepChuyenBay() {
        sort(DanhSach.begin(), DanhSach.end());
    }
};
void DanhSachChuyenBay::input(DanhSachChuyenBay &a) {
...
void DanhSachChuyenBay::timkiemtheongaydivanoidi(string khoihanh,int ng,int t,int n) {
...
void DanhSachChuyenBay::timkiemtheonoidivanoiden(string khoihanh,string dichden)
{
...
int main() {
    ...
    switch(choice)
    {
        ...
        case 2:
        {
            ...
            int ng,t,n;
            cin>>ng>>t>>n;
            ds.timkiemtheongaydivanoidi(khoihanh,ng,t,n);
            break;
        }
        case 3:
        {
            ...
            getline(cin,diemden);
            ds.timkiemtheonoidivanoiden(khoihanh,diemden);
            break;
        }
    }
